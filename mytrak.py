...
output ='inference/output006/'
fourcc=cv2.VideoWriter_fourcc(*'mp4v')
conf_thres = 0.05
source='/media/fulab/2T/data/bacteria-avi/FILC_liquid_001.avi'
        ...
        if save_txt and len(tracked_dets) != 0:
            for j, tracked_dets in enumerate(tracked_dets):
                ...
                with open(txt_path, 'a') as f:
                    f.write(f'{Path(p).name},{frame_idx},{bbox_x1},{bbox_y1},{bbox_x2},{bbox_y2},{category},{confident},{identity}\n')
